  ...
  return (
    <div id="header" className="flex pt-24  xl:pt-0 justify-around min-h-screen items-center flex-wrap overflow-hidden px-5">
      <div className="max-w-xl ">
        ...
        Transforming innovative ideas into real-world solutions. Our team provides cutting-edge technologies to elevate your business and drive growth in a dynamic marketplace.
        </p>
        <div className="flex items-center flex-wrap ">
          {/* <button onClick={handleGetStartedClick}  className="bg-[#3E3FD8] mr-4 flex text-white font-jostMedium w-[170px] h-[60px] rounded-3xl text-xl items-center justify-center">
            Get Started{' '}
            <svg
              width="23"
              height="23"
      ...
      <div className="relative h-full mt-10 md:mt-0">
        ...
        {/* <div className="bg-[#EEF4FF] hidden sm:block shadow-lg absolute bottom-40 -left-24 p-7 rounded-xl ">
          <h1 className="font-jostMedium text-xl text-[#2E323B]">
            Our Creative Team
          </h1>
          <img src="group-image.png" />
        </div> */}
      </div>
    </div>
  )

...
export default function DataAnalyticsDetails() {
  return (
    <div className="flex flex-col items-center justify-center p-6 sm:p-10 bg-gradient-to-br from-blue-50 via-gray-100 to-gray-200 min-h-screen">
      {/* Header Section */}
      <h2 className="text-4xl sm:text-6xl font-bold text-blue-900 mb-8 text-center leading-tight tracking-tight">
        Master Your Data with Advanced Analytics
      </h2>
      <p className="text-base sm:text-lg text-gray-700 mb-12 text-center max-w-3xl">
      ...
      {/* Features Section */}
      <div className="flex flex-wrap justify-center gap-6 sm:gap-12 mb-20">
        {/* Data Collection */}
        <div className="w-full sm:w-1/2 lg:w-1/4 bg-white rounded-2xl shadow-md hover:shadow-2xl p-6 sm:p-8 transform hover:-translate-y-2 transition duration-300">
          ...
          <img
            ...
            alt="Data Collection"
            className="w-full h-40 sm:h-48 object-cover rounded-lg shadow-md mb-4 transition-all duration-300 hover:scale-105"
          />
        </div>
      ...
      <div className="w-full lg:w-3/4 bg-white rounded-2xl shadow-md hover:shadow-2xl p-8 sm:p-12 transform hover:-translate-y-2 transition duration-300 mb-16">
        <h3 className="text-2xl sm:text-3xl font-semibold text-blue-700 mb-6 text-center">
          Data Visualization
        </h3>
      ...
      {/* Conclusion */}
      <p className="text-base sm:text-lg text-gray-700 text-center max-w-3xl leading-relaxed">

...
export default function ProductEngineeringDetails() {
  return (
    <div className="max-w-7xl mx-auto p-6 sm:p-12 bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 text-gray-800 rounded-3xl shadow-xl">
      <h2 className="text-4xl sm:text-6xl font-extrabold text-center mb-8 sm:mb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 sm:gap-16">
        ...
        <div className="bg-white text-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl transform hover:scale-100 transition duration-300">
          <div className="flex justify-center mb-6">
            <FaLaptopCode className="text-4xl sm:text-5xl text-indigo-600" />
          </div>
          <h3 className="text-2xl sm:text-3xl font-semibold mb-4 text-indigo-600">Product Design & Development</h3>
          ...
          <img
            ...
            className="w-full h-48 sm:h-60 object-cover rounded-lg shadow-lg transition-transform transform hover:scale-105"
          />
        </div>
        ...
        <div className="bg-white text-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl transform hover:scale-100 transition duration-300">
          <div className="flex justify-center mb-6">
            <FaCogs className="text-4xl sm:text-5xl text-indigo-600" />
          </div>
          <h3 className="text-2xl sm:text-3xl font-semibold mb-4 text-indigo-600">Scalable Infrastructure</h3>
          <p className="text-base sm:text-lg mb-6">
        ...
        <div className="bg-white text-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl transform hover:scale-100 transition duration-300">
          <div className="flex justify-center mb-6">
            <FaRocket className="text-4xl sm:text-5xl text-indigo-600" />
          </div>
          <h3 className="text-2xl sm:text-3xl font-semibold mb-4 text-indigo-600">Product Launch & Growth</h3>
          <p className="text-base sm:text-lg mb-6">
      ...
      <p className="text-lg sm:text-xl text-center mt-12 sm:mt-16">

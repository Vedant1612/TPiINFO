...
export default function STQADetails() {
  return (
    <div className="flex flex-col items-center p-6 sm:p-8 bg-gray-50 min-h-screen">
      <h2 className="text-3xl sm:text-4xl font-extrabold text-indigo-700 mb-6 sm:mb-8 text-center">
        Enhance Your Software Quality with Our STQA Solutions
      </h2>

      <div className="flex flex-col sm:flex-row items-center justify-between space-y-8 sm:space-y-0 gap-8 sm:gap-10 mb-12 sm:mb-16">
        ...
        <div className="w-full sm:w-1/2 space-y-6 text-center sm:text-left">
          ...
          <ul className="list-disc pl-6 space-y-4 text-lg sm:text-xl text-gray-800">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg w-full sm:w-3/4 lg:w-2/3 mb-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="flex flex-col items-center space-y-2">
            <img 
              ...
              className="w-16 sm:w-24 h-16 sm:h-24 rounded-lg shadow-md"
            />

...
export default function InfraSupportDetails() {
  return (
    <div className="flex flex-col items-center justify-center p-5 sm:p-10 bg-gradient-to-r from-blue-50 via-gray-100 to-white min-h-screen">
      <h2 className="text-3xl sm:text-5xl font-extrabold text-blue-900 mb-6 text-center leading-tight">
        Robust Infrastructure Support for Your Business
      </h2>
      <p className="text-base sm:text-lg text-gray-700 mb-12 text-center max-w-4xl">
      ...
      <div className="flex flex-wrap justify-center gap-8 sm:gap-16 mb-16">
        ...
        <div className="w-full sm:w-1/2 lg:w-1/3 bg-white rounded-lg shadow-lg p-6 sm:p-8 transform hover:scale-100 transition duration-300 hover:shadow-xl">
      ...
      <div className="w-full sm:w-2/3 lg:w-2/3 bg-white rounded-lg shadow-lg p-8 sm:p-12 mb-16 transform hover:scale-100 transition duration-300 hover:shadow-xl">
      ...
      {/* Conclusion */}
      <p className="text-base sm:text-lg text-gray-700 text-center max-w-4xl">
